...
It's probably best to run the examples by  
 1. reading the text before each one  
 2. executing each line one at a time by putting your cursor in the line and hitting [Ctrl][Enter] 

rather than by just executing the chunks. 
