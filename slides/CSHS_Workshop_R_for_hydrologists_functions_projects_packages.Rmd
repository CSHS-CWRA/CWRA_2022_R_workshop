---
title: "CSHS Workshop: R for hydrologists - functions, projects and packages"
author: 
- Kevin Shook 
...
insert a skeleton for the documentation
  ...
  - **roxygen** tags area used by **R** to create package documentation
...
![](figures/project_options.png)
## Set roxygen options
- Configure to run automatically  
![](figures/roxygen_options.png)
